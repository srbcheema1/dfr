...
try:
    ...
    '''
    from dfr import __version__, __mod_name__
...
try:
    ...
    long_description='A command line tool for finding and removing duplicacy',
    requirements = []

setup(
    name=__mod_name__,
    version=__version__,
    description='A command line tool for finding and removing duplicacy',
